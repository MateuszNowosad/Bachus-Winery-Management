        ...
        table: {
          ...
          body: [
            ...
            [
              {
                text: [
                  { text: 'Miejsce przeznaczenia:\n', bold: true },
                  { text: formatAddress(data.pickupAddress), style: 'data' }
                ],
                colSpan: 2
              },
              {},
            ...
            [
              {
                text: [
                  { text: 'Miejsce nadania:\n', bold: true },
                  { text: formatAddress(data.mailingAddress), style: 'data' }
                ],
                colSpan: 2
              },
              {},
            ...
            [
              { text: [{ text: 'Nazwa przesyłki:\n', bold: true }, { text: data.parcel.packageName, style: 'data' }] },
            ...
            [
              {
                text: [
                  { text: 'Zastrzeżenia i uwagi odbiorcy:\n', bold: true },
                  { text: data.comments, style: 'data' }
                ],
                colSpan: 2
              },
              {},
              {
                text: [
                  ...
                  { text: data.reservations, style: 'data' }
                ],
                rowSpan: 2
              }
            ],
